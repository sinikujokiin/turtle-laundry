<div class="content-header">
	<div class="d-flex align-items-center">
		...
		<?php if (access('pelayanan-create')): ?>
		<a class="btn btn-sm btn-primary" href="<?= base_url('services/create') ?>">
				...
				<div class="box-body">
					<div class="table-responsive">
						<table id="example" cellspacing="0" class="table table-striped table-bordered" style="width:100%">
							...
							<tbody>
								<?php $no = 1; foreach ($services as $value): ?>
								<tr>
									<td class="cell"><?= $no++ ?>.</td>
									<td class="cell"><?= $value->name ?></td>
									<td class="cell"><span class="truncate"><?= $value->description ?></span></td>
									<td class="text-nowrap text-center">
										<div class="dropdown">
											...
											<ul class="dropdown-menu" aria-labelledby="dropdownMenuLink" style="z-index: 99999;">
												<?php if (access('pelayanan-update')): ?>
													<li>
														<a class="dropdown-item" href="<?= base_url('services/edit/'.encrypt_decrypt('encrypt', $value->id)) ?>"><i class="fa fa-pencil"></i> Ubah
														</a>
													</li>
												<?php endif ?>
												<?php if (access('pelayanan-delete')): ?>
													<li>
														<a class="dropdown-item" href="javascript:;" onclick="showModalDelete(this)" data-href="<?= base_url('services/destroy/'.encrypt_decrypt('encrypt', $value->id)) ?>" data-type="Pelayanan"><i class="fa fa-trash"></i> Hapus
														</a>
													</li>
												<?php endif ?>
											</ul>
