				...
				<div class="box-body">
					<div class="row">
						<?php $error = $this->session->flashdata('error'); ?>
						    <form class="settings-form" method="post" action="<?= base_url('users/store') ?>" enctype="multipart/form-data">
							    <div class="mb-3">
								    <label for="fullname" class="form-label">Nama Lengkap</label>
								    <input type="text" class="form-control" id="fullname" value="<?= set_value('fullname') ?>" name="fullname" required placeholder="Fulan">
								...
								<div class="row">
									<div class="col-lg-6 col-12">
										<div class="mb-3">
											...
											<div class="form-check">
												<input class="form-check-input" type="radio" <?= set_value('role') == 'Staff' ? 'checked' : '' ?> value="Staff" id="role-staff" name="role" checked>
											 	<label class="form-check-label" for="role-staff">
											    	Staff
												</label>
												<input class="form-check-input" type="radio" <?= set_value('role') == 'Owner' ? 'checked' : '' ?> value="Owner" id="role-owner" name="role" >
									...
									<div class="col-lg-6 col-12">
										<div class="mb-3">
											...
											<div class="form-check">
												<input class="form-check-input" type="radio" <?= set_value('status') == '1' ? 'checked' : '' ?> value="1" id="status-1" name="status" checked>
											 	<label class="form-check-label" for="status-1">
											    	Aktif
												</label>
												<input class="form-check-input" type="radio" <?= set_value('status') == '0' ? 'checked' : '' ?> value="0" id="status-0" name="status" >
								...
								<div class="mb-3">
								    ...
								    <input type="file" accept="image/*" class="form-control" id="image" value="<?= set_value('image') ?>" name="image" placeholder="image">
