<div class="content-header">
	<div class="d-flex align-items-center">
		...
		<a class="btn btn-sm btn-primary" href="<?= base_url('users/create') ?>">
						...
						<table id="example" cellspacing="0" class="table table-striped table-bordered" style="width:100%">
							<thead>
								<tr>
									...
									<th class="cell" width="1%">Status</th>
							...
							<tbody>
								...
								<tr>
									<td class="cell"><?= $no++ ?>.</td>
									<td class="cell text-center" width="10%">
										<?= $value->image ? '<img src="'.base_url($value->image).'" width="50%">' : "-"  ?>
									...
									<td class="cell"><?= $value->role ?></td>
									<td class="cell text-center text-nowrap"><?= $value->status == 1 ? '<span class="badge badge-sm badge-success">Aktif</span>' : '<span class="badge badge-sm badge-danger">Tidak Aktif</span>'  ?></td>
									<td class="text-nowrap text-center">
										<div class="dropdown">
											...
											<ul class="dropdown-menu" aria-labelledby="dropdownMenuLink" style="z-index: 99999;">
												...
												<li>
													<a class="dropdown-item" href="javascript:;" onclick="showModalDelete(this)" data-href="<?= base_url('users/destroy/'.encrypt_decrypt('encrypt', $value->id)) ?>" data-type="Pengguna"><i class="fa fa-trash"></i> Hapus
													</a>
												</li>
												<?php endif ?>
											</ul>
